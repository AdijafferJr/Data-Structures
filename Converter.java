...
public class Converter {
    public static void main(String[] args) {
        ...
        //create variables to show number of coins
        ...
        //add a penny each time amount is divisible by 8 in order to account for accuracy errors due to float
        if (amount >= 8 && amount % 8 == 0) {
            n_pennies += 1;
        }

        //create restaurant menu with items and prices
        ...
        //print menu with header "Our Full Menu"
        System.out.println("Our Full Menu:");
        for (Map.Entry<String, Double> entry : menu.entrySet()) {
            System.out.println(entry.getKey() + ": $" + entry.getValue());
        }

        //print affordable menu items depending on entered amount by user
